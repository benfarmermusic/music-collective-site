...
<html lang="en">
  ...
  <body>
        ...
        <div class="tabblock">
            ...
            <div class="tab-content">
                ...
                <div id="tracksTab" class="tab-pane fade">
                    ...
                    FROM music WHERE `producer` LIKE '%Ben Farmer%'
                    ORDER BY songname";
                ...
                <div id="beatsTab" class="tab-pane fade">
                    ...
                    $query = "SELECT songname, url, producer, type, songartist
                    FROM music WHERE `producer` LIKE '%Ben Farmer%' AND `type` = 'Beat'
                    ORDER BY songname";
                ...
                <div id="songsTab" class="tab-pane fade">
                    ...
                    $query = "SELECT songname, url, producer, type, songartist
                    FROM `music` WHERE `producer` LIKE '%Ben Farmer%' AND `type` = 'Song'
                    ORDER BY songname";
    ...
    <div id="bloc1"> <img src="Images/ben.jpg" width="400px"></div>  
    <div id="bloc2"> 
        <h1> Ben Farmer </h1>
        <h3> Engineer / Producer </h3>
