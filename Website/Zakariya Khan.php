...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="tab-content">
            <div id="tracksTab" class="tab-pane fade">
                ...
                FROM music WHERE `producer` LIKE '%Zakirya Khan%'
                ORDER BY songname";
            ...
            <div id="beatsTab" class="tab-pane fade">
                ...
                $query = "SELECT songname, url, producer, type, songartist
                FROM music WHERE `producer` LIKE '%Zakirya Khan%' AND `type` = 'Beat'
                ORDER BY songname";
            ...
            <div id="songsTab" class="tab-pane fade">
                ...
                $query = "SELECT songname, url, producer, type, songartist
                FROM `music` WHERE `producer` LIKE '%Zakirya Khan%' AND `type` = 'Song'
                ORDER BY songname";
    ...
    <div id="bloc1"> <img src="Images/zak.jpg" width="400px"></div>  
    <div id="bloc2"> 
        <h1> Zakirya Khan </h1>
        <h3> Producer </h3>
