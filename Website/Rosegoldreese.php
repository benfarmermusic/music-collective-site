...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <img class="sketchimages" src="Images/Sunset.png" onclick="changeSketch(2);">  <h4 class = "sketchtitles"> Sunset </h4><br> 
        <img class="sketchimages" src="Images/Fourier_FFT_Web.png" onclick="changeSketch(3);">  <h4 class = "sketchtitles"> Fourier Transform </h4> <br>  
        <img class="sketchimages" src="Images/Rorschach.png" onclick="changeSketch(4);">  <h4 class = "sketchtitles"> Rorschach   </h4> 
        <img class="sketchimages" src="Images/Purple_Rain.png" onclick="changeSketch(5);">  <h4 class = "sketchtitles"> Purple Rain </h4><br>    
        </div>
        ...
        <div id="myCharacters" class="tracks">
            ...
            <ul class="characterul turtlesul">
                <li class="t1" onclick="openZakSite();">Zakarya Khan</li>
        ...
        <!--AUDIO PLAYER -->
         <div id="songinfo" class="text-center songinfo"> 
            ...
            <p> Prod. <span id="producerinfo" class="producerinfo" ></span> </p>
             <audio class="col-4" controls controlslist="nodownload" id="player"></audio>  
        </div>
        ...
        <div class="tab-content">
            <div id="tracksTab" class="tab-pane fade">
                ...
                FROM music WHERE `producer` LIKE '%rosegoldreese%'
                ORDER BY songname";
            ...
            <div id="beatsTab" class="tab-pane fade">
                ...
                $query = "SELECT songname, url, producer, type, songartist
                FROM music WHERE `producer` LIKE '%rosegoldreese%' AND `type` = 'Beat'
                ORDER BY songname";
            ...
            <div id="songsTab" class="tab-pane fade">
                ...
                $query = "SELECT songname, url, producer, type, songartist
                FROM `music` WHERE `producer` LIKE '%rosegoldreese%' AND `type` = 'Song'
                ORDER BY songname";
        ...
        <a href="#" class="arrows next round">&#8250;</a>    
    ...
    <div id="bloc1"> <img src="Images/reese.jpg" width="400px"></div>  
    <div id="bloc2"> 
        <h1> rosegoldreese </h1>
        <h3> Producer </h3>
        <a rel="noopener noreferrer" target="_blank" href="https://www.facebook.com/bfarmdoe" class="fa fa-facebook"></a>
        <a rel="noopener noreferrer" target="_blank" href="#" class="fa fa-twitter"></a>
        <a rel="noopener noreferrer" target="_blank" href="https://www.linkedin.com/in/ben-farmer-1252b3119/" class="fa fa-linkedin"></a>
        <a rel="noopener noreferrer" target="_blank" href="https://www.youtube.com/channel/UCuaRKvQQ5CzUu-regvOlf0A?view_as=subscriber" class="fa fa-youtube"></a>
        <a rel="noopener noreferrer" target="_blank" href="https://www.instagram.com/bfarm4/" class="fa fa-instagram"></a>
        <a rel="noopener noreferrer" target="_blank" href="#" class="fa fa-snapchat-ghost"></a>
        <a rel="noopener noreferrer" target="_blank" href="https://soundcloud.com/benfarmermusic" class="fa fa-soundcloud"></a>
